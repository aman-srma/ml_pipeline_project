...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            # Getting Best Model From report Dict
            ...
            best_model = model[best_model_score]

            logging.info(f"Best Model Is {best_model_name} And Accuracy Score Is {best_model_score}")
